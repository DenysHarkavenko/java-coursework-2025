...
public class CenterServiceImpl implements CenterService {
    ...
    @Override
    @Transactional(readOnly = true)
    public ServiceCenterDTO getCenterDetails(UUID centerId) {
    ...
    @Override
    public ServiceCenterDTO updateCenter(ServiceCenterDTO centerDTO) {
        ServiceCenterEntity center = serviceCenterRepository.findById(centerDTO.getCenterId())
                .orElseThrow(() -> new ServiceCenterNotFoundException("Center not found with id: " + centerDTO.getCenterId()));

        center.setName(centerDTO.getName());
        center.setRating(centerDTO.getRating());
